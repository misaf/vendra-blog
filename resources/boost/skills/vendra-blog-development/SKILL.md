...
Treat `app-modules/vendra-blog` as the source of blog domain behavior and Filament admin UI.
...
- Run module checks from the package when possible: `composer --working-dir=app-modules/vendra-blog test` and `composer --working-dir=app-modules/vendra-blog analyse`.
